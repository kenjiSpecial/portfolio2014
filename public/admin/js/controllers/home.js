...
var homeController = angular.module('myApp.homeControllers', []);

homeController.controller('homeCtrl', ['$scope', '$http', 'Home', function ($scope, $http, Home) {

    var activeClass = angular.element(document.querySelector('.active'));
    activeClass.removeClass('active');

    var navSelectedClass = angular.element(document.querySelector('#admin-home'));
    navSelectedClass.addClass('active');

    $scope.samples = Home.query();
    ...
    $scope.delete = function () {
        ...
        var urlString = '/admin/delete-home/' + id;
    ...
    $scope.update = function () {
        ...
        var urlString = '/admin/update-home/' + id;
        var data = {
            type : type,
    ...
    $scope.create = function () {
        ...
        $http({method: 'POST', url: '/admin/create-home', data: data})
            .success(function (data, status) {
                $scope.type = '';
                $scope.description = '';
